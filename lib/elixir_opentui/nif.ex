defmodule ElixirOpentui.NIF do
  @moduledoc """
  Zig NIF module for high-performance terminal buffer operations.

  Provides a double-buffered cell grid as a NIF resource, batch binary protocol
  for paint operations, and native diff/ANSI generation.
  """
  ...
  @doc "Check if the NIF is available (loaded successfully)."
