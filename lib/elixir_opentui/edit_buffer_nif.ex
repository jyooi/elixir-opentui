defmodule ElixirOpentui.EditBufferNIF do
  ...
  @doc "Convert a wrap mode atom to its integer NIF representation."
  @spec wrap_mode_int(:none | :char | :word) :: 0 | 1 | 2
  def wrap_mode_int(mode), do: Map.fetch!(@wrap_modes, mode)
end
