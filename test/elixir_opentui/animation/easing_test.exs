defmodule ElixirOpentui.Animation.EasingTest do
  ...
  describe "symmetry" do
    ...
    test "in_cubic and out_cubic are symmetric: in_cubic(t) + out_cubic(1-t) == 1" do
      for i <- 0..100 do
        t = i / 100.0
        assert_in_delta Easing.apply(:in_cubic, t) + Easing.apply(:out_cubic, 1.0 - t), 1.0, 1.0e-10
      end
    end
    ...
    test "in_out_quad is symmetric around (0.5, 0.5)" do
      for i <- 1..49 do
        t = i / 100.0
        assert_in_delta Easing.apply(:in_out_quad, t) + Easing.apply(:in_out_quad, 1.0 - t), 1.0, 1.0e-10
      end
    end
    ...
    test "in_out_cubic is symmetric around (0.5, 0.5)" do
      for i <- 1..49 do
        t = i / 100.0
        assert_in_delta Easing.apply(:in_out_cubic, t) + Easing.apply(:in_out_cubic, 1.0 - t), 1.0, 1.0e-10
      end
    end
  end
